...
switch_model_file = "7779K62.stl";
switch_length = inch(1.09);
switch_width = inch(0.63);
switch_thickness = inch(0.41);
switch_hole_diameter = inch(0.12);
switch_hole_spacing = inch(0.88);
...
difference() {
    ...
    // slot closest to arm
    base_slot_offset = (base_length - mount_slot_width) / 3;
