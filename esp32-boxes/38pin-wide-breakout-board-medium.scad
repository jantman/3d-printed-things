...
pcbLength           = inch(2.7);
pcbWidth            = inch(2.0);
pcbThickness        = inch(0.062);

//-- padding between pcb and inside wall
paddingFront        = inch(3.6 - 2.48) + inch(0.5);
paddingBack         = 5 + inch(0.5);
paddingRight        = inch(0.35) + inch(0.5);
paddingLeft         = inch(0.35) + inch(0.5);
...
baseWallHeight      = basePlaneThickness + inch(0.765);
lidWallHeight       = inch(0.4);
...
standoffPinDiameter = 2.5; // hole diameter
...
pcbStands = [
  [ inch(0.590), inch(0.740), standoffHeight, 4, 7, yappBaseOnly, yappHole, yappBackLeft ], // back left
  [ inch(0.590), inch(0.740) + inch(0.4), standoffHeight, 4, 7, yappBaseOnly, yappHole, yappBackLeft ], // back right
  [ inch(0.590) + inch(1.4), inch(0.740), standoffHeight, 4, 7, yappBaseOnly, yappHole, yappBackLeft ], // front left
  [ inch(0.590) + inch(1.4), inch(0.740) + inch(0.4), standoffHeight, 4, 7, yappBaseOnly, yappHole, yappBackLeft ], // front right
];
...
// (6) = { yappCenter }
cutoutsFront = [
  [pcbWidth / 2, inch(0.55), inch(0.25), inch(0.25), 0, yappCircle, yappCenter],
  [pcbWidth / 5, inch(0.55), inch(0.25), inch(0.25), 0, yappCircle, yappCenter],
  [(pcbWidth / 6) * 5, inch(0.55), inch(0.25), inch(0.25), 0, yappCircle, yappCenter],
];
