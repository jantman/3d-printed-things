 ...
 */
#define TEMP_SENSOR_0_FORCE_HW_SPI                // Ignore SCK/MOSI/MISO pins; use CS and the default SPI bus.
...
#define MAX31865_IGNORE_INITIAL_FAULTY_READS 100 // Ignore some read faults (keeping the temperature reading) to work around a possible issue (#23439).
...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 100
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  50, 20 }, { 250,  20 }, { 250, 250 }, { 20, 250 } }
