...
#define CONFIG_EXAMPLES_DIR "config/examples/Creality/CR-10S/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR "jantman" // Who made the changes.
...
#define HEATER_0_MAXTEMP 375  // my heater should go to 500, but the PT100 temp sensor specs say 400 max
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 20.96
  #define DEFAULT_bedKi 1.82
  #define DEFAULT_bedKd 60.35
...
#define NOZZLE_TO_PROBE_OFFSET { -44, -9, -3.40}
