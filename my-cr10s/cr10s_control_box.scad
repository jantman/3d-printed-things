module cr10s_control_box_spool_holder(imported_alpha = 1.0){
    rotate([-90,0,-90]){
...
module cr10s_control_box_shell(imported_alpha = 1.0){
    rotate([-90,0,-90]){
...
module cr10s_control_box_details(imported_alpha = 1.0){
    rotate([-90,0,-90]){
